...
def upgrade() -> None:
    ...
    op.execute("ALTER TABLE graph.node ALTER COLUMN node_type TYPE graph.node_type_enum USING node_type::graph.node_type_enum")
    ...
    op.execute("ALTER TABLE graph.edge ALTER COLUMN edge_type TYPE graph.edge_type_enum USING edge_type::graph.edge_type_enum")
